...
var arraySum = function(array) {
  ...
  // base case: if value is not an array
...
var isEven = function(n) {
  ...
  // base case: if n is between -2 and 2, check if -2 or 2
  if (n >= -2 && n <= 2) {
    return (n === -2 || n === 2);
  }
...
var sumBelow = function(n) {
  ...
  // base case: if n equals 1 or -1, return 0
  if (n === 1) {
    return 0;
  }
...
var range = function(x, y) {
  // return empty array if no integers in range
  if ((x - y) === 0 || Math.abs(x - y) === 1) {
    return [];
  }

  // base case: if y - x is 2 return x + 1
  if ((y - x) === 2) {
    return [x + 1]
  }
...
var exponent = function(base, exp) {
  ...
  // base case: exp is 1, return base
  if (exp === 1) {
    return base;
  }
...
var palindrome = function(string) {
  // base case: return true if string length is 1
  if (string.length === 1) {
    return true;
  }
  ...
  var slice = string.slice(1, string.length - 1);
...
var replaceKeysInObj = function(obj, oldKey, newKey) {
  ...
  for (var key in obj) {
    ...
    // if key equals oldKey, replace with newKey
    if (key === oldKey) {
